We are going to deploy the Grails application developed during this guide to https://cloud.google.com/appengine/docs/flexible/[Google App Engine Flexible Environment]
____
